...
<body>
  <div class="container">
    <header>
      ...
      <p class="lead">Unofficial Debian/Ubuntu packages for Google Antigravity 2.0 (AI desktop agent) and Google Antigravity IDE (agentic coding IDE)</p>
    </header>

    <div class="card">
      <h2>Quick Setup (Ubuntu / Debian)</h2>
      <p>Run the following commands to add the GPG key and APT repository to your system (deb822 format):</p>
...
sudo apt-get install -y antigravity antigravity-ide</code></pre>
      <p>Classic one-line alternative (.list):
        <code>echo "deb [signed-by=/etc/apt/keyrings/antigravity.gpg] https://github.com/chmuri/antigravity-deb/releases/download/stable ./" | sudo tee /etc/apt/sources.list.d/antigravity.list</code>
      </p>
    </div>
    ...
    <div class="card">
      ...
      <ul>
        <li><strong>antigravity</strong> &mdash; Google Antigravity 2.0: autonomous AI desktop agent with sandbox isolation and system tray support. Launcher: <code>antigravity</code>.</li>
        <li><strong>antigravity-ide</strong> &mdash; Google Antigravity IDE: agentic coding IDE with workspace context and GNOME Files integration. Launcher: <code>antigravity-ide</code>.</li>
      </ul>
      <p>Direct download links, checksums and release changelogs are available on <a href="https://github.com/chmuri/antigravity-deb/releases" target="_blank">GitHub Releases</a>.</p>
    </div>

    <div class="card">
      <h2>Security</h2>
      <p>Repository metadata is signed with GPG key
        <code>18EBB53D09F5866F73EB94CF81435F158DF507A0</code>.
        The public key is served at
        <a href="https://chmuri.github.io/antigravity-deb/public.key">chmuri.github.io/antigravity-deb/public.key</a>.
        See the <a href="https://github.com/chmuri/antigravity-deb#readme">README</a> for the full documentation.</p>
    </div>

    <footer>
      <p>Unofficial Google Antigravity Debian/Ubuntu packages &bull; Source on <a href="https://github.com/chmuri/antigravity-deb">GitHub</a></p>
    </footer>
  </div>
</body>
</html>
